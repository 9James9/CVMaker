  ...
  return (
    <div className="container">
      <div className="input-container">
        ...
        {skillsInputs}
        <PdfMaker name={name} job={job} email={email} phone={phone} github={github} workHistory={workHistory} educationHistory={educationHistory} projects={projects} skills={skills}/>
      </div>
